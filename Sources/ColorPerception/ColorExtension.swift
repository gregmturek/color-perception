...
extension Color: ColorConvertible {
    public typealias ColorRepresentation = Color
...
extension Color: PerceptualColor {
    ...
    ///   - cache: Cache to use for contrast decisions (defaults to shared Color cache)
    ...
    public func perceptualContrastingColor<Cache: ContrastPairCache>(
        ...
        using cache: Cache = ContrastPairCaches.colorCache
